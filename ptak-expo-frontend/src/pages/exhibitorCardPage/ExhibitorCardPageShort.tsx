            ...
            {selectedEvent === null
             ...
             : <Box className={styles.singleEventInfo} sx={{flexGrow: 1,width:'100%',bgcolor: 'background.paper'}}>
                ...
                <CustomTabPanel value={value} index={2}>
                  <Box className={styles.tabPaperContainer}>
                    <Box className={styles.leftContainer}>{renderSelectedEvent()}</Box>
                    <Box className={styles.rightContainer}>{exhibitor ? <ExhibitorInvitations exhibitorId={exhibitor.id} exhibitor={exhibitor} exhibitionId={selectedEvent ?? undefined} /> : null}</Box>
                  </Box>                    
                </CustomTabPanel>
                ...
                <CustomTabPanel value={value} index={4}>
                  <Box className={styles.tabPaperContainer}>
                    <Box className={styles.leftContainer}>{renderSelectedEvent()}</Box>
                    <Box className={styles.rightContainer}>{exhibitor ?<ExhibitoiIdentifiers exhibitorId={exhibitor.id} exhibitor={exhibitor} exhibitionId={selectedEvent ?? undefined} /> : null}</Box>
                  </Box>  
                </CustomTabPanel>
                <CustomTabPanel value={value} index={5}>
                  <Box className={styles.tabPaperContainer}>
                    <Box className={styles.leftContainer}>{renderSelectedEvent()}</Box>
                    <Box className={styles.rightContainer}>{exhibitor ?<ExhibitorTradeFairAwards exhibitorId={exhibitor.id} exhibitionId={selectedEvent ?? undefined} /> : null}</Box>
                  </Box>  
                </CustomTabPanel>
                    </Box>}
