  ...
  return (
   <>
    <Box className={styles.singleLine}>
      ...
      {exhibitorsDetails.companyName!==''
      &&<CustomTypography className={styles.value}>MTB Modules Sp. z o.o.</CustomTypography>}
    </Box>
     <Box className={styles.singleLine}>
    ...
    <Box className={styles.singleLine}>
        ...
        <Box className={styles.rowWrapper}>
            <Box className={styles.row}>
                ...
                {exhibitorsDetails.daneKontaktowe.person !==''
                &&<CustomTypography className={styles.value}>Jan Kowalski</CustomTypography>}
            </Box>
            <Box className={styles.row}>
                <CustomTypography className={styles.label}>telefon: </CustomTypography>
                {exhibitorsDetails.daneKontaktowe.phone!=='' 
                && <CustomTypography className={styles.value}>+48 500 549 393</CustomTypography>}
            </Box>
            <Box className={styles.row}>
                <CustomTypography className={styles.label}>e-mail: </CustomTypography>
                {exhibitorsDetails.daneKontaktowe.email!==''
                && <CustomTypography className={styles.value}>joanna@mtbmodule.com</CustomTypography>}
            </Box>
        </Box>
    </Box> 
    <Box className={styles.singleLine}>
      ...
      {exhibitorsDetails.website !==''  
      && <CustomTypography className={styles.value}>https://www.mtbmodule.com</CustomTypography>}
    </Box>
