...
curl -I "https://backend-production-e57c.up.railway.app/api/v1/exhibitor-branding/serve/global/4e4b468e-125a-486c-bc80-b2194db0841a_1759478288613.webp" 2>/dev/null | head -n 10
echo ""
...
curl -I "https://backend-production-e57c.up.railway.app/uploads/marketing-materials/benefit-1759388705632-28627868.svg" 2>/dev/null | head -n 10
echo ""
...
curl -s "https://backend-production-e57c.up.railway.app/public/exhibitions/2/exhibitors/1108.json" | head -c 200
echo "..."
echo ""

echo "Test 4: Check if /uploads is served as static"
echo "Trying direct uploads path..."
curl -I "https://backend-production-e57c.up.railway.app/uploads/" 2>/dev/null | head -n 5
echo ""
