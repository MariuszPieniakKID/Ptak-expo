    ...
    <div className={styles.loginContainer}>
      <div className={styles.loginDataContainer}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          />
          {!emailError && (
            <div className={styles.inputDescription}>Adres E-mail</div>
          )}
          {emailError && (
            <div className={styles.errorInputMessage}>{emailError}</div>
          )}
          ...
          />
          {!passwordError && (
            <div className={styles.inputDescription}>Hasło</div>
          )}
          {passwordError && (
            <div className={styles.errorInputMessage}>{passwordError}</div>
          )}
